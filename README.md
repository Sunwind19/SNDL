...
This is repository for SNDL, a biomimetic robot that is your unique companion for your climate action :  When you pick up, SNDL carries! For this project, there is 2 sub-project -- hardware robot 'SNDL', and the app called ELF where you can follow navigation to collect waste in most efficient way together with SNDL, and calculate impact of your climate action via saved plants & animals through AI model I self-developed by emailing <mark>90+ national parks in U.S</mark>
